...
<?php $component->withAttributes([]); ?>
    ...
    <!--begin::Form-->
    <form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="<?php echo e(route('login')); ?>" action="<?php echo e(route('password.request')); ?>">
        <?php echo csrf_field(); ?>
        <!--begin::Heading-->
        ...
        <div class="d-flex flex-wrap justify-content-center pb-lg-0">
            <button type="button" id="kt_password_reset_submit" class="btn btn-primary me-4">
                <?php echo $__env->make('partials/general/_button-indicator', ['label' => 'Submit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </button>
...
<?php endif; ?>
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/pages/auth/forgot-password.blade.php ENDPATH**/ ?>