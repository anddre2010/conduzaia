	...
	<div class="w-100">
		...
		<div class="fv-row mb-15" data-kt-buttons="true">
			...
			<label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6 mb-6 active">
				...
				<span class="d-flex">
				<!--begin::Icon-->
				<?php echo getSvgIcon('duotune/communication/com006.svg', 'svg-icon svg-icon-3hx'); ?>
			...
			<label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6">
				...
				<span class="d-flex">
				<!--begin::Icon-->
				<?php echo getSvgIcon('duotune/general/gen002.svg', 'svg-icon svg-icon-3hx'); ?>
...
<!--end::Type-->
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/partials/modals/create-project/steps/_type.blade.php ENDPATH**/ ?>