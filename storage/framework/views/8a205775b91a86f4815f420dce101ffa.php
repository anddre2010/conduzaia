...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('breadcrumbs'); ?>
        <?php echo e(Breadcrumbs::render('user-management.permissions.index')); ?>
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_permission">
                        <?php echo getIcon('plus-square','fs-3', '', 'i'); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1577215864-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('permission.permission-modal', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1577215864-1', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/pages/apps/user-management/permissions/list.blade.php ENDPATH**/ ?>