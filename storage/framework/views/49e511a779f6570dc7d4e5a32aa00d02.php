	...
	<div class="w-100">
		...
		<div class="fv-row mb-8">
			...
			<div class="position-relative w-lg-250px" id="kt_modal_create_project_budget_setup" data-kt-dialer="true" data-kt-dialer-min="50" data-kt-dialer-max="50000" data-kt-dialer-step="100" data-kt-dialer-prefix="$" data-kt-dialer-decimals="2">
				...
				<button type="button" class="btn btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 start-0" data-kt-dialer-control="decrease"><?php echo getSvgIcon('duotune/general/gen042.svg', 'svg-icon svg-icon-1'); ?></button>
				...
				<button type="button" class="btn btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 end-0" data-kt-dialer-control="increase"><?php echo getSvgIcon('duotune/general/gen041.svg', 'svg-icon svg-icon-1'); ?></button>
...
<!--end::Budget-->
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/partials/modals/create-project/steps/_budget.blade.php ENDPATH**/ ?>