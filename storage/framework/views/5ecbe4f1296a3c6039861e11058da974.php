				...
				<div class="timeline">
					...
					<div class="timeline-item">
						...
						<div class="timeline-content mb-10 mt-n1">
							...
							<!--begin::Timeline details-->
							<div class="overflow-auto pb-5">
								<?php echo $__env->make('partials/general/_notice', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
							</div>
							<!--end::Timeline details-->
						</div>
						<!--end::Timeline content-->
...
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/partials/drawers/_activity-drawer.blade.php ENDPATH**/ ?>