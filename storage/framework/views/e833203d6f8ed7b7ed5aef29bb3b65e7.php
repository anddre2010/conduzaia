...
<div class="card card-flush h-xl-100">
	...
	<div class="card-header pt-7 mb-5">
		...
		<div class="card-toolbar">
			<a href="<?php echo e(route('dashboard')); ?>" class="btn btn-sm btn-light">View All</a>
		</div>
		<!--end::Toolbar-->
	</div>
	<!--end::Header-->
	...
	<div class="card-body pt-0">
		...
		<div class="m-0">
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="<?php echo e(image('flags/united-states.svg')); ?>" class="me-4 w-25px" style="border-radius: 4px" alt="" />
				<!--end::Flag-->
				<!--begin::Section-->
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="<?php echo e(image('flags/brazil.svg')); ?>" class="me-4 w-25px" style="border-radius: 4px" alt="" />
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
					<!--begin::Content-->
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="<?php echo e(image('flags/turkey.svg')); ?>" class="me-4 w-25px" style="border-radius: 4px" alt="" />
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
					<!--begin::Content-->
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="<?php echo e(image('flags/france.svg')); ?>" class="me-4 w-25px" style="border-radius: 4px" alt="" />
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
					<!--begin::Content-->
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="<?php echo e(image('flags/india.svg')); ?>" class="me-4 w-25px" style="border-radius: 4px" alt="" />
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
					<!--begin::Content-->
					...
					<div class="d-flex align-items-center">
						...
						<div class="m-0">
							<!--begin::Label-->
							<span class="badge badge-light-danger fs-base"><?php echo getIcon('arrow-down', 'fs-5 text-danger ms-n1'); ?> 8.3%</span>
							<!--end::Label-->
						</div>
						<!--end::Label-->
					</div>
			...
			<div class="d-flex flex-stack">
				<!--begin::Flag-->
				<img src="<?php echo e(image('flags/sweden.svg')); ?>" class="me-4 w-25px" style="border-radius: 4px" alt="" />
				<!--end::Flag-->
				<!--begin::Section-->
				<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
					<!--begin::Content-->
...
<!--end::LIst widget 8-->
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/partials/widgets/lists/_widget-8.blade.php ENDPATH**/ ?>