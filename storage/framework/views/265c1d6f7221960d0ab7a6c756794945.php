...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('breadcrumbs'); ?>
        <?php echo e(Breadcrumbs::render('user-management.users.show', $user)); ?>
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <div class="symbol symbol-100px symbol-circle mb-7">
                            <?php if($user->profile_photo_url): ?>
                                <img src="<?php echo e($user->profile_photo_url); ?>" alt="image"/>
                            <?php else: ?>
                        ...
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3"><?php echo e($user->name); ?></a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                            <?php $__currentLoopData = $user->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!--begin::Badge-->
                                <div class="badge badge-lg badge-light-primary d-inline"><?php echo e(ucwords($role->name)); ?></div>
                                <!--begin::Badge-->
                ...
                <div class="card-body pt-2">
                    ...
                    <div class="py-2">
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                <img src="<?php echo e(image('svg/brand-logos/google-icon.svg')); ?>" class="w-30px me-6" alt=""/>
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                <img src="<?php echo e(image('svg/brand-logos/github.svg')); ?>" class="w-30px me-6" alt="" />
                                <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-stack">
                            <div class="d-flex">
                                <img src="<?php echo e(image('svg/brand-logos/slack-icon.svg')); ?>" class="w-30px me-6" alt="" />
                                <div class="d-flex flex-column">
    ...
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Update user details-->
    <!--begin::Modal - Add schedule-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-schedule', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Add schedule-->
    <!--begin::Modal - Add one time password-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-one-time-password', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Add one time password-->
    <!--begin::Modal - Update email-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-email', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Update email-->
    <!--begin::Modal - Update password-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-password', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Update password-->
    <!--begin::Modal - Update role-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_update-role', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Update role-->
    <!--begin::Modal - Add auth app-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-auth-app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Add auth app-->
    <!--begin::Modal - Add task-->
    <?php echo $__env->make('pages/apps/user-management/users/modals/_add-task', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!--end::Modal - Add task-->
    <!--end::Modals-->
...
<?php endif; ?>
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/pages/apps/user-management/users/show.blade.php ENDPATH**/ ?>