    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="<?php echo e(route('dashboard')); ?>" action="<?php echo e(route('login')); ?>">
        ...
        <div class="d-grid mb-10">
            <button type="submit" id="kt_sign_in_submit" class="btn btn-primary">
                <?php echo $__env->make('partials/general/_button-indicator', ['label' => 'Sign In'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </button>
        </div>
        <!--end::Submit button-->
...
<?php endif; ?>
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/pages/auth/login.blade.php ENDPATH**/ ?>