	...
	<div class="card-header py-7">
		...
		<div class="m-0">
			...
			<div class="d-flex align-items-center mb-2">
				...
				<!--end::Title-->
				<!--begin::Badge-->
				<span class="badge badge-light-danger fs-base"><?php echo getIcon('arrow-up', 'fs-5 text-danger ms-n1'); ?> 8.02%</span>
				<!--end::Badge-->
			</div>
			<!--end::Heading-->
			<!--begin::Description-->
		...
		<div class="mb-0">
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-5">
					...
					<div class="symbol symbol-30px me-5">
						<span class="symbol-label"><?php echo getIcon('magnifier', 'fs-3 text-gray-600'); ?></span>
					</div>
					<!--end::Symbol-->
					<!--begin::Content-->
					<div class="me-5">
				...
				<div class="d-flex align-items-center">
					...
					<div class="d-flex flex-center">
						<!--begin::label-->
						<span class="badge badge-light-success fs-base"><?php echo getIcon('arrow-up', 'fs-5 text-success ms-n1'); ?> 2.4%</span>
						<!--end::label-->
					</div>
					<!--end::Info-->
				</div>
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-5">
					<!--begin::Symbol-->
					<div class="symbol symbol-30px me-5">
						<span class="symbol-label"><?php echo getIcon('tiktok', 'fs-3 text-gray-600'); ?></span>
					</div>
					<!--end::Symbol-->
					<!--begin::Content-->
					<div class="me-5">
				...
				<div class="d-flex align-items-center">
					...
					<div class="d-flex flex-center">
						<!--begin::label-->
						<span class="badge badge-light-danger fs-base"><?php echo getIcon('arrow-down', 'fs-5 text-danger ms-n1'); ?> 9.4%</span>
						<!--end::label-->
					</div>
					<!--end::Info-->
				</div>
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-5">
					<!--begin::Symbol-->
					<div class="symbol symbol-30px me-5">
						<span class="symbol-label"><?php echo getIcon('sms', 'fs-3 text-gray-600'); ?></span>
					</div>
					<!--end::Symbol-->
					<!--begin::Content-->
					<div class="me-5">
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-5">
					<!--begin::Symbol-->
					<div class="symbol symbol-30px me-5">
						<span class="symbol-label"><?php echo getIcon('icon', 'fs-3 text-gray-600'); ?></span>
					</div>
					<!--end::Symbol-->
					<!--begin::Content-->
					<div class="me-5">
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-5">
					<!--begin::Symbol-->
					<div class="symbol symbol-30px me-5">
						<span class="symbol-label"><?php echo getIcon('abstract-25', 'fs-3 text-gray-600'); ?></span>
					</div>
					<!--end::Symbol-->
					<!--begin::Content-->
					<div class="me-5">
...
<!--end::List widget 7-->
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/partials/widgets/lists/_widget-7.blade.php ENDPATH**/ ?>