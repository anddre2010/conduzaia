...
<div class="modal fade" id="kt_modal_add_auth_app" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                    ...
                    <div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
                        <img src="<?php echo e(image('misc/qr.png')); ?>" alt="Scan this QR code" />
                    </div>
                    <!--end::QR code-->
                    <!--begin::Text code-->
    ...
    <!--end::Modal dialog-->
</div><?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/pages/apps/user-management/users/modals/_add-auth-app.blade.php ENDPATH**/ ?>