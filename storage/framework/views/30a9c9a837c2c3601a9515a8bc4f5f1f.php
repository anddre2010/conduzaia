	...
	<div class="w-100">
		...
		<div class="fv-row mb-10">
			...
			<div class="dropzone" id="kt_modal_create_campaign_files_upload">
				...
				<!--begin::Icon-->
				<?php echo getSvgIcon('duotune/files/fil010.svg', 'svg-icon svg-icon-3hx svg-icon-primary'); ?>
			...
			<div class="mh-300px scroll-y me-n7 pe-7">
				...
				<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
					<div class="d-flex align-items-center">
						...
						<div class="symbol symbol-35px">
							<img src="<?php echo e(image('svg/files/pdf.svg')); ?>" alt="icon" />
						</div>
						<!--end::Avatar-->
						<!--begin::Details-->
						<div class="ms-6">
				...
				<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
					<div class="d-flex align-items-center">
						<!--begin::Avatar-->
						<div class="symbol symbol-35px">
							<img src="<?php echo e(image('svg/files/tif.svg')); ?>" alt="icon" />
						</div>
						<!--end::Avatar-->
						<!--begin::Details-->
						<div class="ms-6">
				...
				<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
					<div class="d-flex align-items-center">
						<!--begin::Avatar-->
						<div class="symbol symbol-35px">
							<img src="<?php echo e(image('svg/files/folder-document.svg')); ?>" alt="icon" />
						</div>
						<!--end::Avatar-->
						<!--begin::Details-->
						<div class="ms-6">
				...
				<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
					<div class="d-flex align-items-center">
						<!--begin::Avatar-->
						<div class="symbol symbol-35px">
							<img src="<?php echo e(image('svg/files/css.svg')); ?>" alt="icon" />
						</div>
						<!--end::Avatar-->
						<!--begin::Details-->
						<div class="ms-6">
				...
				<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
					<div class="d-flex align-items-center">
						<!--begin::Avatar-->
						<div class="symbol symbol-35px">
							<img src="<?php echo e(image('svg/files/ai.svg')); ?>" alt="icon" />
						</div>
						<!--end::Avatar-->
						<!--begin::Details-->
						<div class="ms-6">
				...
				<div class="d-flex flex-stack py-4">
					<div class="d-flex align-items-center">
						<!--begin::Avatar-->
						<div class="symbol symbol-35px">
							<img src="<?php echo e(image('svg/files/doc.svg')); ?>" alt="icon" />
						</div>
						<!--end::Avatar-->
						<!--begin::Details-->
						<div class="ms-6">
...
<!--end::Step 2-->
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/partials/modals/create-campaign/steps/_step-2.blade.php ENDPATH**/ ?>