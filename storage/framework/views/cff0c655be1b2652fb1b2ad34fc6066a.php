		...
		<div class="d-flex flex-wrap d-grid gap-5 px-9 mb-5">
			...
			<div class="m-0">
				...
				<div class="d-flex align-items-center mb-2">
					...
					<!--end::Value-->
					<!--begin::Label-->
					<span class="badge badge-light-success fs-base"><?php echo getIcon('black-up', 'fs-7 text-success ms-n1'); ?> 4.5%</span>
					<!--end::Label-->
				</div>
				<!--end::Statistics-->
				<!--begin::Description-->
...
<!--end::Chart widget 20-->
<?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/partials/widgets/charts/_widget-20.blade.php ENDPATH**/ ?>