        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    <!--begin::Icon-->
                    <?php echo getIcon('information','fs-2tx text-warning me-4'); ?>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <label class="fs-6 fw-semibold form-label mb-2">
                            ...
                            <span class="ms-2" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Permission names is required to be unique.">
                                <?php echo getIcon('information','fs-7'); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/metronic/8/v8.2.9/laravel/starterkit/resources/views/livewire/permission/permission-modal.blade.php ENDPATH**/ ?>